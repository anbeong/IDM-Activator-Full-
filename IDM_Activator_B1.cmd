...
cls
title  IDM Activation v6.42 - Beong.eu.org
mode 90, 30
...
set "reg=HKCU\SOFTWARE\DownloadManager /v FName /t REG_SZ /d "beong.eu.org"" & call :_rcont
...
set /a attempt=0
if exist "%file%" del /f /q "%file%"
start "" /B "!IDMan!" /n /d "https://www.internetdownloadmanager.com/register/IDMlib/images/idman_logos.png" /p "%_temp%" /f temp.png
